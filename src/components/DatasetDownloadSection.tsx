...
export default function DatasetDownloadSection() {
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(["sector-indices", "large-cap"]);
  ...
  const groups: DownloadGroup[] = [
      ...
      datasets: [
        {
          ...
          description: "Complete unified OHLCV time series for all 36 sector indices from Jan 2015 to Aug 2026 in a single file.",
          format: "CSV",
          size: "7.84 MB",
        ...
        },
        {
          ...
          description: "Individual CSV file per sector, plus metadata and classification summaries.",
          format: "ZIP Archive",
          size: "2.28 MB",
          timeline: "Jan 2015 – Aug 2026",
        ...
        },
        {
          ...
          description: "High-precision 1-hour candlestick OHLCV for all 36 sector baskets for intraday modeling.",
          format: "ZIP Archive",
          size: "2.27 MB",
        ...
        {
          id: "metrics-summary",
          title: "Sector Metrics & Risk/Return Matrix",
          filename: "coep_36_sector_indices_metrics_summary.csv",
          description: "11.66-year CAGR, Sharpe ratios, annualized volatility, and max drawdown per sector.",
          format: "CSV",
          size: "6.6 KB",
    ...
    // ── MASTER REGISTRY & AUDIT ──
    {
      id: "registry",
      label: "Master Registry & Audit Reports",
      emoji: "📋",
      description: "Universe coverage summary, data quality verification, and all-in-one daily bundle",
      accent: "purple",
      datasets: [
        {
          ...
          description: "Registry of all 1,213 equities with exact 5-minute & Daily timelines, bar counts, market cap tiers, sector groupings, and availability status.",
          format: "CSV",
          size: "169.5 KB",
        ...
        },
        {
          ...
          description: "Single ZIP containing daily OHLCV for all 1,213 universe stocks regardless of cap tier. Includes Master_Universe_Summary.csv.",
          format: "ZIP Archive",
          size: "36.70 MB",
          timeline: "Jan 3, 2022 – Aug 28, 2026",
          records: "1,162,971 Daily Bars",
          badge: "Complete Universe",
          badgeColor: "purple",
          icon: Archive,
        },
        {
          id: "equities-cross-audit",
          title: "Dataset Cross-Verification Audit Report",
          filename: "Full_Dataset_Cross_Verification_Report.csv",
          description: "Full audit validating timestamp continuity, split adjustments, and data integrity across all 1,213 equities.",
          format: "CSV",
          size: "65.9 KB",
          timeline: "Jan 2022 – Aug 2026",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-4 border-b border-border/60">
          <div>
            ...
            <p className="mt-2 text-sm sm:text-base text-muted-foreground font-light max-w-2xl">
              Institutional-grade datasets for India's 36 Sector Indices and all 1,213 equities — categorised by market cap tier. Daily OHLCV + full 5-minute intraday Parquet bundles.
            </p>
          </div>
