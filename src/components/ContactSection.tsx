...
import { Mail, MapPin, Building2, Github, Linkedin, Youtube, CheckCircle2, Rocket, Flame, Sparkles, Send } from "lucide-react";
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-28 px-4 max-w-6xl mx-auto flex flex-col items-center">
      ...
      {/* ── Ultra-Aesthetic Dual-Pane Contact & Work Selector Card ── */}
      <motion.div
      ...
      >
        {/* ── Jhey Tompkins Radiant Animated Glow Border ──────── */}
        <div className="absolute -inset-[1px] rounded-2xl pointer-events-none opacity-30 overflow-hidden">
          <div className="absolute -inset-[200%] animate-[spin_8s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_0_340deg,#00ffd6_360deg)]" />
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-xs font-mono uppercase tracking-wider text-white/60 mb-2 flex items-center justify-between">
                ...
                <span className="text-[10px] text-cyan-400 font-normal">Choose topic</span>
              </label>
